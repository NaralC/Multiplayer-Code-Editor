      ...
      <div className="page-background">
        <div className="h-screen min-w-0 w-40 duration-300 md:w-64 p-5 bg-slate-900 text-4xl flex flex-col justify-between overflow-y-auto">
          ...
          <div>
            <button
              type="button"
              className="btn outline-none border-0 w-full text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium truncate rounded-lg text-xs md:text-lg px-5 py-2.5 text-center mr-2 mb-2"
            ...
            <button
              type="button"
              className="btn outline-none border-0 w-full text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium truncate rounded-lg text-xs md:text-lg px-5 py-2.5 text-center mr-2 mb-2"
